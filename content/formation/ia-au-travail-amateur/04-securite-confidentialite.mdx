...
published: true
qcm:
  - question: "Quelle technique simple permet d'utiliser l'IA avec des données sensibles sans les exposer ?"
    options:
      - "Utiliser uniquement le plan gratuit"
      - "Anonymiser les données avant de les coller (remplacer les infos sensibles par des placeholders)"
      - "Ne jamais utiliser l'IA pour ce type de données"
      - "Utiliser un VPN"
    answer: 1
  - question: "Quel plan OpenAI offre les meilleures garanties contractuelles pour les entreprises ?"
    options:
      - "Le plan gratuit"
      - "ChatGPT Plus individuel"
      - "ChatGPT Team ou Enterprise"
      - "Tous les plans ont les mêmes garanties"
    answer: 2
  - question: "Qu'est-ce qu'un modèle IA 'en local' et quel avantage présente-t-il ?"
    options:
      - "Un modèle installé sur votre serveur d'entreprise avec des données envoyées dans le cloud"
      - "Un modèle qui tourne sur votre propre machine sans envoyer de données à l'extérieur"
      - "Un modèle disponible uniquement en France"
      - "Un modèle sans connexion internet requis pour l'installation"
    answer: 1
  - question: "En Europe, quelle réglementation s'applique au traitement de données personnelles via des outils IA ?"
    options:
      - "La loi DADVSI"
      - "Le RGPD (Règlement Général sur la Protection des Données)"
      - "La directive NIS2 uniquement"
      - "Aucune réglementation spécifique n'existe encore"
    answer: 1
---
