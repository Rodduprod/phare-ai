...
export function FormationSignupCTA() {
  ...
  return (
    <div className="bg-gradient-to-r from-primary/10 to-blue-50 border border-primary/20 rounded-2xl px-4 sm:px-6 py-5 mb-10">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 w-full sm:w-auto shrink-0">
          <Link
            ...
            className="px-5 py-2.5 bg-primary hover:bg-primary-hover text-white text-sm font-semibold rounded-xl transition-colors text-center"
          >
            S&apos;inscrire gratuitement
          </Link>
          <Link
            href="/compte/connexion"
            className="px-5 py-2.5 border border-border text-text text-sm font-medium rounded-xl hover:border-primary/40 hover:text-primary transition-colors text-center"
          >
            Se connecter
          </Link>
        </div>
